...
from app.modules.qualification.buyer_seller_classifier import (
    classify_rule_based, apply_buyer_seller_penalty,
    BuyerSellerLabel, BuyerSellerResult,
)
...
def _ctx(**kw):
    return BusinessContext(industries=["manufacturing"], location="Riyadh", **kw)
